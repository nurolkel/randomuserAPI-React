        ...
        <div key={prev.id}>
            <div className="flex flex-col items-center justify-center">
                <div className="flex flex-col justify-center">
                    <div className="flex flex-col p-5 items-center justify-center">
                        ...
                        <span className="uppercase text-lg p-2 font-semibold">{prev.name.first} Profile Page!</span>
                    </div>
            ...
            <div className="p-5 flex flex-col justify-center items-center text-center">
                ...
                <div className="text-xl">
                    <p  className="py-2 text-2xl">{prev.location.street.number} {prev.location.street.name} ,{prev.location.city}</p>
                    <p className="py-2 text-2xl">{prev.location.state} {prev.location.postcode}</p>
                </div>
            </div>
            <div className="p-5 flex flex-col items-center">
                <p>My email is: <span className="uppercase font-bold">{prev.email}</span></p>
                <div className="p-5 flex flex-col items-center justify-center">
                    <p>Call me at:</p>
                    <div className="flex flex-row items-center py-5">
                        <AiFillMobile  className="text-2xl text-purple-500" /> {prev.cell}
                    </div>
                    <div className="flex flex-row items-center py-5">
                        <AiFillPhone  className="text-2xl text-purple-500"/> {prev.phone}
                    </div>
                </div>
                <p className="text-lg">I am {prev.dob.age} years old and was born on {formatedDOB}</p>
            </div>
